    ...
    <section class="page-header bg_img padding-tb">
        ...
        <div class="container">
            <div class="page-header-content-area">
                <h4 class="ph-title">KVKK</h4>
                <ul class="lab-ul">
                    <li>Hesap oluşturmadan önce lütfen KVKK metnini okuyunuz.</li>
                </ul>
            </div>
        </div>
    </section>
...
 KVKK gereğince, aşağıda sayılanlar ve bunlara ileride eklenebilecek sair kanallar vasıtasıyla Kişisel Verilerinizi otomatik yahut otomatik olmayan yollarla, sözlü, yazılı veya elektronik şekilde aşağıdaki yöntemlerle toplamakta ve KVKK Madde 5.1, Madde 5.2, Madde 6.2 ve Madde 6.3 kapsamında işlemekteyiz:	 
	•	https://kuzeydeyariyil.com.tr/  adresli internet sitemiz ve ileride kurulabilecek sair internet sitelerimiz (“İnternet Sitesi”) üzerinden aşağıdaki sayfalar başta olmak ancak bunlarla sınırlı olmaksızın otomatik veya otomatik olmayan yollarla elektronik olarak,
	...
	•	Bize Sağladığınız Kişisel Veriler: Yukarıda belirtilen kanallar üzerinden herhangi bir şekilde tarafımızla paylaştığınız her türlü Kişisel Veriyi işbu Aydınlatma Metni içerisinde yer alan esaslar ve amaçlar dahilinde işlemekteyiz. Bu kapsamda, İnternet Sitemiz üzerinden üyelik kaydı yahut hizmet satın alırken akdedilen profesyonel sözleşmeler ve mesafeli satış sözleşmeleri kapsamında paylaştığınız ad-soyad, doğum tarihi, diploma, öğrenim durumu, T.C. Kimlik numarası, telefon numarası, e-mail adresi, adres gibi Kişisel Verileriniz, İnternet Sitelerimizin kullanımı esnasında paylaştığınız Özel Nitelikli Kişisel Verileri de barındırabilecek Kişisel Verileriniz, tarafımıza İletişim Araçları vasıtası ile ilettiğiniz Kişisel Verileriniz yahut bir hizmetin ifası için paylaştığınız Kişisel Verileriniz, örnek olarak gösterilebilir.	 
...
 
Yukarıda anılan kanallar vasıtasıyla paylaştığınız Kişisel Verileriniz bakımından Veri Sorumlusu, “Gazi Blv. No:112/601 Susuzlu İş Hanı İsmet Kaptan  KONAK /İzmir” adresinde kayıtlı Agora Rotaract Derneği ’dir.	 
	•	Kişisel Verilerinizin İşlenme Amaçları

İşbu Aydınlatma Metni’nde anılan kanallardan, anılan yöntemlerle toplanan Kişisel Verileriniz aşağıdaki amaçlar dahilinde Agora Rotaract Derneği tarafından işlenmektedir:
